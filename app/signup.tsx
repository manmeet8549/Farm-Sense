...
export default function SignupScreen() {
  ...
  return (
    <ImageBackground 
      source={{ uri: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=2000&auto=format&fit=crop' }} 
        ...
        >
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.headerSection}>
              <Text style={styles.welcomeText}>Join FarmSense</Text>
              <Text style={styles.subText}>Start your smart farming journey today</Text>
            </View>
